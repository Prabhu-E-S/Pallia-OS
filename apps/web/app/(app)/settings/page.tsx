...
const DEMO_ACCOUNTS = [
  { email: "admin@pallia.demo", role: "Administrator" },
  { email: "coordinator@pallia.demo", role: "Care coordinator" },
  { email: "nurse@pallia.demo", role: "Nurse" },
  { email: "nurse2@pallia.demo", role: "Nurse" },
  { email: "doctor@pallia.demo", role: "Doctor" },
  { email: "caregiver@pallia.demo", role: "Caregiver" },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card>
          <CardHeader title="Demo accounts" description="Phase 1 development logins" />
          <CardBody>
